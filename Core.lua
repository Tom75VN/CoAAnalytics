local ADDON_NAME = ...
local ADDON_VERSION = CoAAnalyticsAddon and CoAAnalyticsAddon.VERSION or "3.1.1"
...
local RANKING_MAX_VISIBLE_ROWS = 20
...
CoAAnalyticsAPI.Config = {
	...
	RANKING_MAX_VISIBLE_ROWS = RANKING_MAX_VISIBLE_ROWS,
