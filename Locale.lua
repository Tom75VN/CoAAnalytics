...
local ENGLISH = {
	...
	["Minicarte BG"] = "BG Minimap",
	["Raid sur la minicarte"] = "Raid on the Minimap",
	["Afficher le raid et les drapeaux en BG"] = "Show raid members and flags in battlegrounds",
	["Taille des points : "] = "Marker size: ",
	["Taille par defaut"] = "Default Size",
	["Affiche en BG les membres des autres sous-groupes en violet et les drapeaux de capture sur la minicarte normale."] =
		"Shows members of other raid subgroups in purple and live capture flags on the normal minimap in battlegrounds.",
	["echelle exacte"] = "exact scale",
	["mode universel"] = "universal mode",
	["taille : "] = "size: ",
	["raid : "] = "raid: ",
	["drapeaux : "] = "flags: ",
	["taille des points : "] = "marker size: ",
	["utilisation : /coaa minimap size 6-20"] = "usage: /coaa minimap size 6-20",
	["commandes : /coaa minimap on, off, toggle, size 6-20, status"] =
		"commands: /coaa minimap on, off, toggle, size 6-20, status",
	["active"] = "enabled",
	["desactive"] = "disabled",
